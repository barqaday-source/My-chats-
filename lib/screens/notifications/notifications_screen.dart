          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Expanded(
                  child: Text('الإشعارات', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800)),
                ),
                TextButton.icon(
                  onPressed: _markRead,
                  icon: const Icon(Icons.done_all_rounded, size: 16),
                  label: const Text('قراءة الكل', style: TextStyle(fontSize: 13)),
                ),
              ],
            ),
          ),
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text('لا توجد إشعارات', style: TextStyle(color: AppColors.textSub, fontSize: 16, fontWeight: FontWeight.w500)),
                        const SizedBox(height: 6),
                        const Text('ستظهر إشعاراتك هنا', style: TextStyle(color: AppColors.textSub, fontSize: 13)),
                      ],
                    ),
                  );
                }
                      ...
                      child: Dismissible(
                        ...
                        background: Container(
                          ...
                          child: const Row(
                            children: [
                              ...
                              SizedBox(width: 8),
                              Text('حذف', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700)),
                            ],
                          ),
                        ),
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(20),
                            border: Border.all(
                              color: n.isRead? AppColors.glassBorder : c.withOpacity(0.35),
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  // TODO: avatar - إذا NotificationModel فيه avatarUrl أستبدل الأيقونة بـ UserAvatar
                                  Stack(
                                    children: [
                                      Container(
                                        width: 46, height: 46,
                                        ...
                                        Row(
                                          children: [
                                            Container(
                                              ...
                                              child: Text(_label(n.type), style: TextStyle(color: c, fontSize: 10, fontWeight: FontWeight.w700)),
                                            ),
                                            const Spacer(),
                                            Text(timeago.format(n.createdAt, locale: 'ar'), style: const TextStyle(color: AppColors.textSub, fontSize: 10)),
                                          ],
                                        ),
                                        const SizedBox(height: 6),
                                        Text(n.title, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w700, height: 1.3)),
                                        const SizedBox(height: 4),
                                        Text(n.body, style: const TextStyle(color: AppColors.textSub, fontSize: 12, height: 1.5), maxLines: 3, overflow: TextOverflow.ellipsis),
                                      ],
                                    ),
                                  ),
                                ],
